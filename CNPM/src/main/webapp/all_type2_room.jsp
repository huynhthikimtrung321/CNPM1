				...
				<div class="card crd-ho">
					<div class="cart-body">
						...
						<div class="row">
							...
							if (u == null) {
							%>
							<a href="login.jsp" class="btn btn-danger btn-sm ml-3">Book Now</a>
							<%
							} else {
							%>
							<a href="cart?bid=<%=b.getRoomId()%>&&uid=<%=u.getId()%>"
								class="btn btn-danger btn-sm ml-3">Book Now</a>
							<%
							}
							%>
							
							<a
								href="view_books.jsp?bid=<%=b.getRoomId()%>" class="btn btn-success btn-sm ml-1">View Details</a>
